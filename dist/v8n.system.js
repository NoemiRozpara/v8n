System.register("v8n", [], function(exports, module) {
  "use strict";
  return {
    execute: function() {
        ...
        function ValidationError(rule, value, cause, target) {
          ...
          for (
            var _len = arguments.length,
              remaining = Array(_len > 4 ? _len - 4 : 0),
              _key = 4;
            _key < _len;
            _key++
          ) {
          ...
          var _this = possibleConstructorReturn(
            this,
            (
              ValidationError.__proto__ ||
              Object.getPrototypeOf(ValidationError)
            ).call(this, remaining)
          );
      ...
      function proxyContextEs5(context) {
        var buildRuleSet = function buildRuleSet(ruleSet) {
          return Object.keys(ruleSet).forEach(function(prop) {
            context[prop] = function() {
              var newContext = proxyContextEs5(context._clone());
              return newContext
      ...
      var availableRules = {
        ...
        passesAnyOf: function passesAnyOf() {
          for (
            var _len = arguments.length, validations = Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
        ...
        optional: function optional(validation) {
          var considerTrimmedEmptyString =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : false;
          return function(value) {
